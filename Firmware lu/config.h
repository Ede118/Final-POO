...
#define INVERSE_X_STEPPER false // CHANGE IF STEPPER MOVES OTHER WAY // true en robot del lab
#define INVERSE_Y_STEPPER false // CHANGE IF STEPPER MOVES OTHER WAY // true en robot del lab
